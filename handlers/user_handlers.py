...
@user_router.callback_query(F.data == 'sub_extend')
async def open_private_menu(clb: CallbackQuery, dialog_manager: DialogManager):
    ...
    if dialog_manager.has_context():
        ...
        try:
            ...
            ...
    await dialog_manager.start(startSG.private_menu, mode=StartMode.RESET_STACK)
